...
class AppStrings {
  ...
  static const Map<String, Map<String, String>> _values = {
    'en': {
      ...
      'resolutionFallback': 'This device does not support the selected mode; a compatible resolution is being used.',
      'landscapeHint': 'Rotate your phone to landscape',
    ...
    'zh': {
      ...
      'cameraError': '无法打开摄像头',
      'resolutionFallback': '此设备不支持所选模式，已自动使用兼容的分辨率。',
      'landscapeHint': '请将手机横向放置',
      'review': '预览录制',
      'title': '标题（选填）',
      'experimentId': '实验编号',
      'participantId': '参与者编号',
